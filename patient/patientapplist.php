...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>"><i class="fas fa-print"></i> Appointment</a>
							</li>
							<li class="divider"></li>
							<li>
	...
	while ($userRow = mysqli_fetch_array($res)) {
		...
		echo "<td><a href='invoice.php?appid=" . $userRow['appId'] . "' target='_blank'><span class='fas fa-print' aria-hidden='true'></span></a> </td>";
	}
