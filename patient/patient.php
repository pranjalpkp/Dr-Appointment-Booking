...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-8">
					...
					?>
					<!-- notification end -->
					<h2>Hi<span style="font-family: Ubuntu; color:red"> <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?></span> Make Appointment Today!</h2>
	...
	<div class="copyright-bar bg-black">
		<div class="container">
			<p class="pull-left small">© Dr Sinha</p>
		</div>
	</div>
	<!-- footer end -->
