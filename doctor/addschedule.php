                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Book Avail" disabled></th>
                            ...
                            while ($doctorschedule = mysqli_fetch_array($result)) {
                                ...
                                echo "<td class='text-center'><a href='#' id='" . $doctorschedule['scheduleId'] . "' class='delete'><span class='fas fa-trash' aria-hidden='true'></span></a>
                            </td>";
                            }
                            echo "</tr>";
                            echo "</tbody>";
